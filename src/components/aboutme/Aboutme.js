  ...
  return (
    <div className='AboutMe'>
      <div className='description'>
        <p>
          Soy una persona apasionada por programación, autodidacta y centrada en
          los detalles.
        </p>
        <p>Apunto a un perfil de desarrollador fullstack.</p>
        <h2>estudios</h2>
        <p>
        ...
        <p>
          ...
          centré en aplicar buenas practicas y soluciones simples. Profundizando
          sobre todo el desarrollo escalable de mis soluciones.
        </p>
        <h2>trabajos</h2>
        <p>
